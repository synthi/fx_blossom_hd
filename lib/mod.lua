...
function FxBlossom:add_params()
    ...
    params:add_group("fx_blossom", "fx blossom", 7)
    ...
    FxBlossom:add_taper("fx_blossom_bloom", "bloom", "bloom", 0.01, 4.0, 0.5, 0, "s")
    ...
    FxBlossom:add_taper("fx_blossom_damp", "damp", "damp", 150, 15000, 10000, 4, "hz")
